...
class Curl
{
    ...
    protected $_ci;                 // URL of the session
    protected $response = '';   // Populates curl_setopt_array
    protected $session;   // Populates extra HTTP headers
    protected $url;             // Error code returned as an int
    protected $options = array();           // Error message returned as a string
    protected $headers = array();                   // Returned after request (elapsed time, etc)
