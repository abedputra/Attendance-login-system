...
<div class="col-md-8 col-lg-offset-2">
    ...
    <div class="container well col-md-12">
        <div class="row">
            ...
            <div class="col-md-7">
                <h3><i class="fa fa-user-circle" aria-hidden="true"></i> <?php echo $first_name . " " . $last_name; ?>
                </h3>
            ...
            <div class="col-md-2">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo site_url(); ?>profileuser/edituser"><span class="icon-wrench"></span>
                                Edit</a></li>
                    </ul>
                </div>
            </div>
