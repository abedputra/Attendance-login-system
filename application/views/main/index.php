                    ...
                    <div class="col-md-6">
                        <div class="progress">
                            <div class="progress-bar progress-bar-success progress-bar-striped active"
                                 ...
                                 style="width: <?php echo $allabsetPerc; ?>">

                            </div>
                        </div>
                        <h4 class="progress-label"><?php echo $allabsetPerc; ?> or <?php echo $count_absent_today; ?>
                            Person
                            Absent Today.</h4>
                    </div>
                    <div class="col-md-6">
                        <div class="progress">
                            <div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar"
                                 aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
                                 style="width: <?php echo $allLatePerc; ?>">

                            </div>
                        </div>
                        <h4 class="progress-label"><?php echo $allLatePerc; ?> or <?php echo $count_late_today; ?>
                            Employees
                            are late Today.</h4>
                    </div>
                </div>
